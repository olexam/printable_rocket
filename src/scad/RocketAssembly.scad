...
translate([0,0,450+2* tubeLength]) NoseCone(72, internalDiameter, true, overlap, wallThicknes, holderBarLength, holderBarDiameter, tlrnc, noseConeType);
translate([0,0,300+2* tubeLength]) CamAltimeterTube(100, internalDiameter, wallThicknes, frameThicknes, overlap, holderBarLength, holderBarDiameter, tlrnc);
translate([0,0,250+2 * tubeLength]) rotate([0, 0, 180]) TubeFitter(internalDiameter, wallThicknes, overlap, tlrnc, rodDiam, perimeter);
translate([0,0,200 + tubeLength]) MainTube(tubeLength, internalDiameter, wallThicknes, overlap, tlrnc);
